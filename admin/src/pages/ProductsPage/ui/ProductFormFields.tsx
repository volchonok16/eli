...
export function ProductFormFields({ form, setField, categories, salePoints }: FormFieldsProps) {
  ...
  return (
    <>
      <div className="form-section">
        ...
        <div className="form-row">
          <div className="form-group">
            ...
            <input id="name" value={String(form.name)} onChange={(e) => setField("name", e.target.value)} required placeholder="Русская ель" />
          </div>
          <div className="form-group">
            <label htmlFor="sku">Артикул (SKU)</label>
            <input id="sku" value={String(form.sku)} onChange={(e) => setField("sku", e.target.value)} placeholder="EL-001" />
          </div>
        </div>

        <div className="form-group">
          <label htmlFor="description">Описание</label>
          <textarea id="description" value={String(form.description)} onChange={(e) => setField("description", e.target.value)} rows={4} placeholder="Подробное описание товара..." />
          <p className="form-hint">Отображается на странице товара</p>
        </div>
      ...
      <div className="form-section">
        <h2 className="form-section-title">Классификация</h2>
        <div className="form-row">
          <div className="form-group">
      ...
      <div className="form-section">
        <h2 className="form-section-title">Цены и склад</h2>
        <div className="form-row">
          <div className="form-group">
        ...
        <div className="form-row">
          <div className="form-group">
            ...
            <p className="form-hint">Не показывается покупателям</p>
          </div>
          <div className="form-group">
