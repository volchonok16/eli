...
const benefits = [
  {
    ...
    description: 'Ёлки срезаются непосредственно перед доставкой. Каждое дерево проходит контроль: форма кроны, цвет хвои, отсутствие сухих веток.',
  },
  {
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 text-accent">
    ...
    description: 'Доставка по Москве и области за 1–3 дня. Привезём в удобное время, занесём в помещение, поможем установить в подставку.',
  },
  {
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 text-accent">
    ...
    title: 'Простоит до 4 недель',
    description: 'Свежий срез и правильный уход — ваша ёлка будет радовать глаз весь декабрь и январь. Даём инструкцию по уходу к каждому заказу.',
  },
  {
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 text-accent">
    ...
    description: 'Поможем подобрать ёлку под ваш интерьер и бюджет. Проконсультируем по высоте, сорту, подставке и аксессуарам.',
  },
  {
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 text-accent">
    ...
    description: 'Подставки, упаковка, вывоз ёлки после праздников — всё в одном заказе. Вам остаётся только наряжать.',
  },
  {
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 text-accent">
    ...
    description: 'Работаем с сертифицированными лесхозами. После праздников организуем сбор и переработку ёлок в щепу для городских парков.',
  },
];
  ...
  <section className="py-24 bg-surface-dark relative overflow-hidden">
    ...
    <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <SectionHeading
        ...
        subtitle="Мы делаем покупку новогодней ёлки простой, быстрой и приятной — от выбора до установки в вашем доме"
      />
