...
const steps = [
  {
    step: '01',
    title: 'Выбор ёлки',
    description: 'В каталоге или на ёлочном базаре выберите подходящую высоту и сорт. Менеджер проконсультирует по телефону или в чате.',
    icon: (
  ...
  },
  {
    ...
    description: 'Привезём ёлку в удобное время или заберите сами с ближайшего базара. Упакуем, занесём, поможем установить в подставку.',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
  ...
  },
  {
    step: '03',
    title: 'Праздник',
    description: 'Ёлка установлена и готова к украшению. Свежий срез обеспечит стойкость до 4 недель. В январе заберём на переработку.',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
    ...
    <section ref={containerRef} className="py-24 bg-surface relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <SectionHeading
          ...
          subtitle="Три простых шага — и живая ёлка у вас дома"
        />
